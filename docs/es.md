...
- Para situar las **coordenadas** pulsa el botón **🗺️ Elegir en el mapa**: se abre un sub‑diálogo con capas **Topo** (por defecto), **Satélite** y **Calles**, más un buscador integrado para localizar un lugar por nombre. Toca el mapa o arrastra el marcador para situar el despegue con precisión en una ladera o cresta, y pulsa *Usar estas coordenadas* para confirmar. Si lo prefieres, los campos de latitud y longitud siguen siendo editables a mano.
